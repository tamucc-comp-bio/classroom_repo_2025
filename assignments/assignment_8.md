...
Complete the following exercises by making an R script with code that answers or addresses each question.  

* Within the R script, make a collapsable section for each question (e.g. #### Question 1 ####).
* Include each question as a comment inside of each collapsable section.
* Use the "unrolled" coding format with pipes I've been promoting in class, and be sure to follow every comma and pipe with a "line feed".
...
> [!CAUTION]
> R for Data Science has been updated more recently than the solutions, so the numbering or even the questions may not always match between exactly between the two. I've very deliberately labeled each link below to be correct.
...
> [!CAUTION]
> I'm only asking you to complete the first question for exercise 5.2.4. The solutions for exercise 5.2.4.1 are under [solution to exercise 5.2.1](https://jrnold.github.io/r4ds-exercise-solutions/transform.html#exercise-5.2.1)
...
> [!NOTE]
> From here forward, you will be expected to locate the solutions.
